...
//Introduction
/**
 * The initiative is about cities, architecture and urban systems in the metaverse, in the physical world, and in cyber-physical realities.
 * The aim is to enable the organic formation from the ground up of an interdisciplinary community ecosystem focused on the Design, Research,
 * 
 ...
 *
 *@community EMLCC is 365 days long
 *@community we expect novel and 
 * Tickets distribution at creation time 
 * 2.5 Million tickets available for purchase are transferred to an Unstoppable Blockchain Vending Machine;
 * 0.25 Million tickets are allocated to EMLCC account. Their purpose is simple and powerful.  
 *         
 * @dev we make a couple of customisations to the ERC20 standard
 * $EMLCC as a voting ticket does not have 18 decimals as expected for an ERC20 crypto-token
